...
wire [1:0]   atomic_type_w    = routed_tlp[25:24];
...
tag_manager #(.TAG_POOL_SIZE(64)) U_TAG_MGR (
    .clk               (clk),
    .rst_n             (rst_n),
...
tlp_malformed_checker U_MAL_CHK (
    ...
    .tlp_fmt       (rx_tlp_fmt),
    .tlp_len       (rx_tlp_len),
    .tlp_first_be  (dll_tlp_rx_r[35:32]),
    .tlp_last_be   (dll_tlp_rx_r[39:36]),
    .parse_valid   (rx_parse_valid),
...
aer_error_logger U_AER (
    ...
    .err_from_ur  (cpl_ur_w),
    .dll_err       (dll_err_to_aer[3:0]),
