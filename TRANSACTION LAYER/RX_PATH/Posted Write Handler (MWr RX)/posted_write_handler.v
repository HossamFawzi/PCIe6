...
module pcie_mwr_hdl (
    ...
    always @(posedge clk or negedge rst_n) begin
        if (!rst_n) begin
            ...
            mwr_be    <= be_expanded;
            mwr_valid <= 1'b1;
            // Note: mwr_valid is not auto-cleared; upstream must
            // throttle using mwr_full, or downstream latches data
            // on the valid pulse and mwr_valid persists harmlessly.
        end
    end
