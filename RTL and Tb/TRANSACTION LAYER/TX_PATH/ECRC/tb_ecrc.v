// =============================================================================
// tb_ecrc_gen_chk.v
// Final Perfected Testbench (Buffered Pipeline Isolation)
// =============================================================================
...
module tb_ecrc_gen_chk;
    ...
    initial begin
        ...
        // ---------------------------------------------------------
        // TC1: TX Path - Standard Generation
        // ---------------------------------------------------------
        ...
        // Save the perfectly generated packet!
        saved_good_tlp = tlp_ecrc_tx;
        
        // Turn off TX and let the pipeline settle for 1 clock cycle
        @(negedge clk); 
        tlp_tx_valid = 1'b0; 
        @(posedge clk); #1; 

        // ---------------------------------------------------------
        // TC2: RX Path - Standard Good Check (Buffered Input)
        // ---------------------------------------------------------
        $display("\nTC2: RX Path - Standard Good Check");
        @(negedge clk);
        tlp_rx       = saved_good_tlp; // Inject the saved packet
        tlp_rx_valid = 1'b1;
        ...
        // ---------------------------------------------------------
        // TC6: Dynamic Control - Toggling ECRC_EN Mid-Burst
        // ---------------------------------------------------------
        ...
        // ---------------------------------------------------------
        // TC9: Protocol Check - Ignored Data when Valid is Low
        // ---------------------------------------------------------
        ...
        // ---------------------------------------------------------
        // TC10: Burst Error Injection (Full Byte Corruption)
        // ---------------------------------------------------------
