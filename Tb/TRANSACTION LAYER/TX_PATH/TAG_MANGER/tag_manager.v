...
reg [1023:0] free_bitmap;
reg [10:0]   outstanding_int;
reg [9:0]    prev_timeout_tag;

reg [63:0] store_addr [0:1023];
reg [9:0]  store_len  [0:1023];
reg [3:0]  store_type [0:1023];
...
always @(posedge clk or negedge rst_n) begin
    if (!rst_n) begin
        ...
        outstanding_count <= (next_cnt > 11'd1023) ? 10'd1023 : next_cnt[9:0];
